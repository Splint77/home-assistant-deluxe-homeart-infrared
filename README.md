...
Home Assistant integration for Deluxe Homeart LED candles controlled via infrared. Since the candles have no feedback channel, state is assumed and tracked locally.

> This is not an official Deluxe Homeart integration. IR codes were reverse-engineered from the FB-0001 remote using a BroadLink RM4 Pro.
...
2. Add `https://github.com/Splint77/Deluxe-Homeart-Infrared-HA` as an **Integration**
3. Search for **Deluxe Homeart Infrared** and download it
