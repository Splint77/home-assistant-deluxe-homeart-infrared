"""Base entity for the Schou Infrared integration."""
...
from .const import DOMAIN, SchouCode

_LOGGER = logging.getLogger(__name__)


class SchouEntity(Entity):
    """Schou Infrared base entity."""
    ...
    async def _send_command(self, code: SchouCode) -> None:
